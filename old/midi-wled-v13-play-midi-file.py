...
# MIDI_FILE = "twinkle-twinkle-little-star.mid"  # Update with the path to your MIDI file
MIDI_FILE = "clair-de-lune.mid"  # Update with the path to your MIDI file
...
print("Playing MIDI file and controlling LEDs. Press Ctrl+C to exit.")
try:
